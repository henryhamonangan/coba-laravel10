...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            @else
                <img src="https://source.unsplash.com/1200x400/?{{ $posts[0]->category->name }}" class="card-img-top img-fluid" alt="{{ $posts[0]->category->name }}">
            @endif
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            @else
                                <img src="https://source.unsplash.com/500x400?{{ $post->category->name }}" class="card-img-top img-fluid" alt="{{ $post->category->name }}">
                            @endif
                            <div class="card-body">
